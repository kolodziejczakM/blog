...
const About = () => {
    return (
        <StyledGrid>
            ...
            <StyledSection>
                <StyledParagraph>
                    I'm Senior Front-end Developer currently living in Poznań. In my free
                    time I participate in open source projects, like these:
                </StyledParagraph>
                <StyledAnchor
                ...
                />
                <StyledParagraph>
                    In the past I used to direct short movies so feel free to ask about
                    anything related :)
                </StyledParagraph>
            </StyledSection>
        </StyledGrid>
